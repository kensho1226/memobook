...
class Create2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if saves.object(forKey: "memo2") != nil && titlenamearray.count != 0 && memoNo != ""{
            memoarray = saves.object(forKey: "memo2") as! [String]
            print(memoarray)
            titleTextField.text = String(titlenamearray[Int(memoNo)!])!
            memo.text = String(memoarray[Int(memoNo)!])
        }else if saves.object(forKey: "memo2") != nil && titlenamearray.count != 0{
            memoNo = "0"
            memoarray = saves.object(forKey: "memo2") as! [String]
            print(memoarray)
            titleTextField.text = String(titlenamearray[Int(memoNo)!])!
